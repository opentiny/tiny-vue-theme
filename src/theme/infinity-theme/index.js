...
export const infinityTheme = {
  ...
  'ti-button-normal-hover-text-color': 'var(--ti-base-color-common)',
  'ti-button-text-color': '#526ecc',
  'ti-button-text-color-hover': 'var(--ti-base-color-brand-1)',
  ...
  'ti-radio-bordered-checked-hover-border-color': 'var(--ti-base-color-brand-1)',
  'ti-radio-bordered-border-color': '#d7d8da',
  'ti-radio-input-disabled-bg-color': '#f5f5f5',
  'ti-switch-off-bg-color': '#d7d8da',
  'ti-link-default-text-color': 'var(--ti-base-color-brand-2)',
  'ti-link-default-hover-text-color': 'var(--ti-base-color-brand-1)',
  ...
  // tabs
  'ti-tabs-header-font-active-border-color': 'var(--ti-base-color-common)',
  'ti-tabs-header-text-color': 'var(--ti-base-color-common)',
  ...
  'ti-tabs-icon-close-hover-bg-color': 'var(--ti-base-color-common)',
  ...
  'ti-tooltip-box-shadow': 'var(--ti-popover-box-shadow)',
  'ti-tooltip-popper-border-color': 'var(--ti-popover-bg-color)',
  'ti-tooltip-popper-dark-bg-color': 'var(--ti-popover-bg-color)',
  'ti-tooltip-popper-light-text-color': 'var(--ti-popover-bg-color)',
  'ti-tooltip-popper-light-border-color': 'var(--ti-popover-bg-color)',
  'ti-tooltip-padding-vertical': 'var(--ti-popover-padding-vertical)',
  'ti-tooltip-padding-horizontal': ' var(--ti-popover-padding-horizontal)',
  'ti-tooltip-color': 'var(--ti-popover-text-color)',
  'ti-tooltip-popper-dark-text-color': 'var(--ti-popover-text-color)',
  ...
  'ti-date-table-td-today-text-color': 'var(--ti-base-color-brand)',
  ...
  'ti-alert-info-bg-color': 'var(--ti-base-color-brand-6)',
  ...
  'ti-carousel-arrow-active-text-color': 'var(--ti-base-color-common)',
  ...
  'ti-notify-text-color': 'var(--ti-base-color-common-4)',
  ...
  'ti-alert-info-icon-color': 'var(--ti-base-color-brand)',
  'ti-alert-warning-icon-color': 'var(--ti-base-color-warn)',
  'ti-alert-error-icon-color': 'var(--ti-base-color-error)',
  'ti-alert-success-icon-color': 'var(--ti-base-color-success)',
  'ti-notify-close-icon-color': 'var(--ti-base-color-common-4)',
  'ti-notify-title-text-color': 'var(--ti-base-color-common-4)',
  ...
  'ti-input-active-border-color': 'var(--ti-base-color-brand-2)',
  ...
  'ti-cascader-node-selectable-hover-text-color': 'var(--ti-base-color-brand-2)',
  'ti-cascader-node-disabled-text-color': '#cfd0d3',
  'ti-cascader-node-disabled-bg-color': '#f5f5f5',
  'ti-cascader-node-icon-color': 'var(--ti-base-color-common)',
  ...
  'ti-cascader-tag-bg-color': 'var(--ti-base-color-brand-6)',
  'ti-tag-info-text-color': '#71757f',
  'ti-cascader-hover-border-color': '#71757f',
  'ti-cascader-focus-border-color': 'var(--ti-base-color-brand)',
  'ti-cascader-node-selectable-text-color': 'var(--ti-base-color-brand-2)',
  'ti-cascader-node-hover-text-color': 'var(--ti-base-color-brand-2)',
  // select
  'ti-select-input-caret-text-color': 'var(--ti-base-color-common-1)',
  'ti-select-input-caret-hover-text-color': 'var(--ti-base-color-common)',
  // option
  ...
  'ti-select-dropdown-item-selected-bg-color': 'var(--ti-base-color-brand-7)',
  // form-item
  'ti-form-item-error-text-color': 'var(--ti-base-color-error)',
